  ...
  return (
    <div className="video-player-section__info">
      ...
      <div className="video-player-section__meta">
        ...
        <div className="video-player-section__actions">
          <button className="video-player-section__button action-button">
          ...
          <button className="video-player-section__button action-button">
            <svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8.55556 0L14 5.6L8.55556 11.2V7.92C4.66667 7.92 1.94444 9.2 0 12C0.777778 8 3.11111 4 8.55556 3.2V0Z" />
            </svg>
            <span>Share</span>
          </button>

          <button className="video-player-section__button video-player-section__button--doted">
            <span></span>
          </button>
        </div>
      </div>
