...
const VideoDescription = ({ title, descriptionText }) => {
  ...
  return (
    <div className="video-player-section__description video-description">
      <div className="video-description__top-bar">
        <h2 className="video-description__title">{title}</h2>
        <button onClick={toggleDescOpen} className="video-description__show-button">
